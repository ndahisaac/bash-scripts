...
<body>
	...
	<div class='IntroMsg'>
     ...
     <div class="menu">   
        <div class="menuIntro">     
            <!-- img tile system -->
            <img src="https://i0.wp.com/laviebami.com/wp-content/uploads/2021/04/njama1-5.jpg?resize=1024%2C683&ssl=1"/>
    ...
    <div class="menu">   
        <div class="menuIntro">    
            <img  id="caption_img"src="https://legideon.org/admin/pictures/articles/606/78dd4f6928a6ba0ff1a7cf9f0aacceca.jpeg"  />  
	...
	<ul>
		<li>
			<span class="dish">Fufu Corn and Njama Njama</span>
			<span class="Price">$12</span>
			<span class="Description">cheese, onions, tomotoes. 
			</span>
		</li>
		<li>
			<span class="dish">Achu.</span>
			<span class="Price">$12</span>
   ...
   <!-- coded by cryptograghi 2023 Isaac Tosam  :) -->
